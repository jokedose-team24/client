...
export default {
    ...
    methods: {
        getFlight() {
            http
                .get('http://172.17.0.200:9000/api/flight')
                .then(response => {
        ...
        getAirplane() {
            http
                .get("http://172.17.0.200:9000/api/airplane")
                .then(response => {
        ...
        deleteFlight(id) {
            http
                .delete("http://172.17.0.200:9000/api/flight/id/" + id).then(res => {
        ...
        saveFlight() {
            http({
                    method: 'post',
                    url: "http://172.17.0.200:9000/api/flight/create",
                    data: {
