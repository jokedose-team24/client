...
export default {
    ...
    methods: {
        ...
        saveBaggage() {
            http
                .post(
                    "http://172.17.0.200:9000/api/adds-on/" +
                    this.form.maxWeight +
                    "/" +
                    this.form.price +
                    "/" +
        ...
        deleteBag(id) {
            http.delete("http://172.17.0.200:9000/api/adds-on/" + id).then(res => {
                console.log(res.data);
                this.getBaggage();
        ...
        getBaggagetype() {
            http
                .get("http://172.17.0.200:9000/api/baggage-type/")
                .then(bag => {
        ...
        getBaggage() {
            http
                .get(
                    "http://172.17.0.200:9000/api/adds-on/airport/" + this.filterAirportId
                )
                .then(res => {
        ...
        getImage() {
            http
                .get("http://172.17.0.200:9000/api/baggage-image")
                .then(bimage => {
        ...
        getAirport() {
            http
                .get("http://172.17.0.200:9000/api/airport")
                .then(aerodrom => {
